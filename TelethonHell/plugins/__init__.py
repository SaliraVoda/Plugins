...
my_channel = Config.MY_CHANNEL or "Hellbot_Extended"
my_group = Config.MY_GROUP or "HellBot_Extended"
if "@" in my_channel:
    my_channel = my_channel.replace("@", "")
if "@" in my_group:
    my_group = my_group.replace("@", "")

chnl_link = "https://t.me/Hellbot_Extended"
grp_link = "https://t.me/HellBot_Extended"
